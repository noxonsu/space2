...
1. Скопируйте `_template.yaml` и переименуйте в `your_product.yaml`
2. Создайте класс продукта в `/src/backend/services/products/`
3. Заполните YAML конфигурацию

Подробная инструкция: [docs/ADMIN_PRODUCTS.md](docs/ADMIN_PRODUCTS.md)
