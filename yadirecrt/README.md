...
```env
YANDEX_CLIENT_ID=9ba5833fea41491ab3ea12fb37044691
YANDEX_CLIENT_SECRET=14a04229a65e4e35a3944c6b9b32dae0
...
1. Перейдите на `/auth/yandex/url` для получения ссылки авторизации
2. Пройдите авторизацию в Яндексе
3. Получите токен доступа из колбэка
4. Используйте токен для работы с API

### Настройка OAuth приложения

В настройках вашего приложения в Яндексе:
- **Client ID**: `9ba5833fea41491ab3ea12fb37044691`
- **Client Secret**: `14a04229a65e4e35a3944c6b9b32dae0`
- **Redirect URI**: `https://habab.ru/redirect`
