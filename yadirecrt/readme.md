это сервис который управляет компаниями в яндекс директе. он нахзодит компании, сздают группы объявление и генерирует через openai объявления и url. на входе должен подаваться файл вида 
